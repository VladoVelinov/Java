...
import OOP.inheritance.onlineradiodatabase.songexceptions.InvalidSongMinutesException;
import OOP.inheritance.onlineradiodatabase.songexceptions.InvalidSongSecondsException;
...
public class SongDuration extends Duration {
    ...
    public void setSeconds(int seconds) throws InvalidSongSecondsException {
        if (seconds < 0 || seconds > 59)
            throw new InvalidSongSecondsException("Seconds must be between 0 and 59!!");
